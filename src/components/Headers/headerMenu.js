...
export default function HeaderMenu() {
    return (
      <header className="absolute top-0 flex items-center justify-center h-20 w-full">
        <div className="flex items-center align-middle justify-between bg-white hover:bg-gray-100 px-8 py-2 rounded-full shadow-md w-2/3 max-w-4xl">
